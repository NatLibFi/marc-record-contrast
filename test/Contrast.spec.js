...
var PreferredRecordSelector = require("../lib/marc-record-contrast");
...
describe('PreferenceMelinda', function() {
	...
	describe('extractReprintInfo', function() {
		...
		var testReprintInfo = selector.extractReprintInfo(testRecord);
		var otherReprintInfo = selector.extractReprintInfo(otherRecord);
		...
		it('should give points to earlier record with reprint info that contains the year of the latter record.', function() {
			...
			selector.normalizeVectors(vec1, vec2, [selector.normalizers.reprintNormalizer]);
